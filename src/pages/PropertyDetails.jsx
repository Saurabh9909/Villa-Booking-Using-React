...
export default function PropertyDetails() {
  ...
  return (
    <div>
      <BreadCrum page="Property-Details" title="Property-Details" />
      <div className="single-property section">
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <div className="main-image">
                <img src={`../../${property.villaPoster}`} alt="" />
              </div>
              <div className="main-content">
                <span className="category">{property.villaType}</span>
                <h4>{property.villaAddress}, OR {property.villaConactDetails}</h4>
                <p>Get <strong>the best villa agency</strong> HTML CSS Bootstrap Template for your company website. TemplateMo provides you the <a href="https://www.google.com/search?q=best+free+css+templates" target="blank">best free CSS templates</a> in the world. Please tell your friends about it. Thank you. Cloud bread kogi bitters pitchfork shoreditch tumblr yr succulents single-origin coffee schlitz enamel pin you probably haven't heard of them ugh hella.
